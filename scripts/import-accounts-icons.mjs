/**
 * Download user-provided Accounts submenu icons and normalize to 64×64 PNG.
 * Requires: npm install sharp (dev/local). Run: node scripts/import-accounts-icons.mjs
 */
...
const outDir = path.join(root, 'public', 'images', 'sidebar', 'accounts');
const tmpDir = path.join(root, 'scripts', '.tmp-accounts-icons');

const icons = [
  { file: 'dues.png', url: 'https://i.ibb.co.com/wZcZb9Fn/Due-Management-accounts-icon.jpg' },
  { file: 'receivables.png', url: 'https://i.ibb.co.com/bg3YVkB3/Customer-Due-Cash-accounts-icon.png' },
  { file: 'payables.png', url: 'https://i.ibb.co.com/FqcjrjDW/Supplier-Due-Bank-accounts-icon-icon.jpg' },
  { file: 'journals.png', url: 'https://i.ibb.co.com/gLpkfSVS/Journal-Entries-accounts-icon.jpg' },
  { file: 'ledger.png', url: 'https://i.ibb.co.com/nNzmV9fq/General-Ledger-accounts-icon.jpg' },
  { file: 'trial.png', url: 'https://i.ibb.co.com/DZv9x6V/Trial-Balance-accounts-icon.jpg' },
  { file: 'pl.png', url: 'https://i.ibb.co.com/PsSCTRtz/Profit-Loss-accounts-icon.png' },
  { file: 'balance.png', url: 'https://i.ibb.co.com/zWw943cq/Balance-Sheet-accounts-icon.jpg' },
];
