/**
 * Download user-provided HR submenu icons and normalize to 64×64 PNG.
 * Requires: npm install sharp (dev/local). Run: node scripts/import-hr-icons.mjs
 */
...
const outDir = path.join(root, 'public', 'images', 'sidebar', 'hr');
const tmpDir = path.join(root, 'scripts', '.tmp-hr-icons');

const icons = [
  { file: 'employees.png', url: 'https://i.ibb.co.com/Rky8GQy3/Employees-HR-icon.png' },
  { file: 'departments.png', url: 'https://i.ibb.co.com/xSndg8BG/Departments-HR-icon.png' },
  { file: 'designations.png', url: 'https://i.ibb.co.com/6R9TLbcG/Designations-HR-icon.png' },
  { file: 'attendance.png', url: 'https://i.ibb.co.com/q4CtJ6Z/Attendance-HR-icon.jpg' },
  { file: 'leave.png', url: 'https://i.ibb.co.com/Dfwm8qV2/Leave-Management-HR-icon.png' },
];
