/**
 * Download user-provided Payroll submenu icons and normalize to 64×64 PNG.
 * Requires: npm install sharp (dev/local). Run: node scripts/import-payroll-icons.mjs
 */
...
const outDir = path.join(root, 'public', 'images', 'sidebar', 'payroll');
const tmpDir = path.join(root, 'scripts', '.tmp-payroll-icons');

const icons = [
  { file: 'structures.png', url: 'https://i.ibb.co.com/FLQRypKD/Salary-Structures-payroll-icon.webp' },
  { file: 'runs.png', url: 'https://i.ibb.co.com/NnxGY45f/Payroll-Runs-payroll-icon.png' },
  { file: 'slips.png', url: 'https://i.ibb.co.com/jZ6p4fKM/ayslips-payroll-icon.jpg' },
];
