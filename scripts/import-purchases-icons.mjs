/**
 * Download user-provided Purchases submenu icons and normalize to 64×64 PNG.
 * Requires: npm install sharp (dev/local). Run: node scripts/import-purchases-icons.mjs
 */
...
const outDir = path.join(root, 'public', 'images', 'sidebar', 'purchases');
const tmpDir = path.join(root, 'scripts', '.tmp-purchases-icons');

const icons = [
  { file: 'suppliers.png', url: 'https://i.ibb.co.com/5XZKTPbJ/Suppliers-Purchases-icon.webp' },
  { file: 'orders.png', url: 'https://i.ibb.co.com/h1B6W7n1/Orders-Purchases-icon.png' },
  { file: 'goods-received.png', url: 'https://i.ibb.co.com/Wp6h6nsH/Goods-Received-Purchases-icon.webp' },
  { file: 'bills.png', url: 'https://i.ibb.co.com/q3nLRBH2/Vendor-Bills-Purchases-icon.webp' },
  { file: 'payments.png', url: 'https://i.ibb.co.com/d4Qy4mfd/Payments-Purchases-icon.png' },
