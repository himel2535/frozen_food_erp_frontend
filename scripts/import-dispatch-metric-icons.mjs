/**
 * Download colorful Icons8 Color KPI icons for Dispatch Management metrics.
 * Requires: sharp. Run: node scripts/import-dispatch-metric-icons.mjs
 */
import fs from 'fs';
...
const tmpDir = path.join(root, 'scripts', '.tmp-dispatch-metric-icons');

const icons = [
  { file: 'total.png', url: 'https://img.icons8.com/color/96/box.png' },
  { file: 'scheduled.png', url: 'https://img.icons8.com/color/96/calendar.png' },
  { file: 'on-route.png', url: 'https://img.icons8.com/color/96/truck.png' },
  { file: 'delivered.png', url: 'https://img.icons8.com/color/96/checked.png' },
];
