...
const MAP: Record<string, string> = {
  ...
  planning: 'bg-indigo-50 text-indigo-700 border-indigo-200/60',
  'on-hold': 'bg-amber-50 text-amber-700 border-amber-200/60',
  'to-do': 'bg-blue-50 text-blue-700 border-blue-200/60',
  todo: 'bg-blue-50 text-blue-700 border-blue-200/60',
