  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        {showBadge ? (
          <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-rose-500 text-white text-[9px] font-extrabold flex items-center justify-center border-2 border-white pointer-events-none">
            {badgeLabel}
          </span>
        ) : null}
      </button>
      ...
      {open ? (
        <div className="fixed left-2 right-2 top-[58px] md:absolute md:left-auto md:right-0 md:top-full md:inset-x-auto md:w-[380px] mt-3 z-50">
          <div
            className="absolute -top-1.5 right-[90px] md:right-3.5 w-3 h-3 bg-white border-l border-t border-slate-200 rotate-45"
            aria-hidden
          />
