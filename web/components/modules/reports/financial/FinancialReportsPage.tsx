      ...
      <div className={MODULE_LIST_SHELL}>
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          <div className="flex items-start gap-3 min-w-0">
            <Icon icon="fluent-color:money-hand-24" width={32} height={32} className="shrink-0 mt-0.5" />
            <div className="min-w-0">
              <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">{t('reports.financial_title')}</h2>
              <p className="text-xs text-slate-500 mt-1 font-medium">{t('reports.financial_subtitle')}</p>
            </div>
          </div>
