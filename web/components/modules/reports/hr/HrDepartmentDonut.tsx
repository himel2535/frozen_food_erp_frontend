...
import { HR_DEPT_SLICE } from '@/components/modules/reports/hr/hr-report-styles';
import type { HrBreakdownSlice } from '@/components/modules/reports/hr/hr-report-utils';

export function HrDepartmentDonut({
  slices,
  totalHeadcount,
  onPrint,
}: {
