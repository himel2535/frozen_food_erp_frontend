      ...
      <div className={MODULE_LIST_SHELL}>
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
          <div className="flex items-start gap-3 min-w-0">
            <Icon icon="fluent-color:people-24" width={32} height={32} className="shrink-0 mt-0.5" />
            <div className="min-w-0">
              <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">{t('reports.hr_title')}</h2>
              <p className="text-xs text-slate-500 mt-1 font-medium">{t('reports.hr_subtitle')}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3">
            <div className="relative min-w-[240px] flex-1 max-w-md">
              ...
              <input
                ...
                placeholder={t('reports.hr_search_placeholder')}
        ...
        <section>
          <ReportSectionHeader
            title={t('reports.hr_print_metrics')}
