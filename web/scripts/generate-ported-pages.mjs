...
const MODULE_TO_ROUTE = {
  ...
  'purchases-recipes': '/purchases/recipes/finished-goods',
  'recipes-finished-goods': '/purchases/recipes/finished-goods',
  'recipes-semi-finished': '/purchases/recipes/semi-finished',
...
const DEDICATED_PAGES = {
  ...
  'purchases-recipes': { importPath: '@/lib/modules/recipes-pages', componentName: 'FinishedGoodsBomPage' },
  'recipes-finished-goods': { importPath: '@/lib/modules/recipes-pages', componentName: 'FinishedGoodsBomPage' },
  'recipes-semi-finished': { importPath: '@/lib/modules/recipes-pages', componentName: 'SemiFinishedBomPage' },
