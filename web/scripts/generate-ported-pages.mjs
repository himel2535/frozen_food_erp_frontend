...
const DEDICATED_PAGES = {
  ...
  'manufacturing-orders': { importPath: '@/lib/modules/manufacturing-pages', componentName: 'ManufacturingOrdersPage' },
  'manufacturing-bom': { importPath: '@/lib/modules/manufacturing-pages', componentName: 'BomPage' },
