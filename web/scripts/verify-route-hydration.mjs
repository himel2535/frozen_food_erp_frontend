...
const moduleCases = [
  ...
  { path: '/accounting/receivables', expected: ['customers', 'invoices'], note: 'Customers + invoices for due table' },
  ...
  { path: '/projects/my-tasks', expected: [], note: 'Uses dedicated /pm-tasks/my endpoint' },
];
...
const queryCases = [
  ...
  { path: '/accounting/receivables', module: 'invoices', limit: 100 },
  { path: '/accounting/receivables', module: 'customers', limit: 200 },
...
const ROUTE_PREFETCH = {
  ...
  '/projects': 'pmProjects',
  '/projects/my-tasks': [],
  '/accounting/receivables': ['customers', 'invoices'],
...
const ROUTE_MODULE_QUERIES = {
  ...
  '/accounting/receivables': { invoices: { page: 1, limit: 100 }, customers: { page: 1, limit: 200 } },
