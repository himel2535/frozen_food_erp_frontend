...
export function mapApiProductRow(doc: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    stockDurationDays: doc.stockDurationDays ?? 0,
    stockDurationStartedAt: doc.stockDurationStartedAt ?? null,
    uom: doc.uom ?? 'pcs',
...
export function mapProductPayloadToApi(body: ProductFormPayload): Record<string, unknown> {
  ...
  const payload: Record<string, unknown> = {
    ...
    stockDurationDays: Number(body.stockDurationDays ?? 0),
    uom: body.uom,
...
export function mapApiSalesOrderRow(doc: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    attachmentUrl: m.attachmentUrl ?? doc.attachmentUrl ?? '',
    attachmentPublicId: m.attachmentPublicId ?? doc.attachmentPublicId ?? '',
    attachmentName: m.attachmentName ?? doc.attachmentName ?? '',
    createdAt: doc.createdAt,
    updatedAt: doc.updatedAt,
    _mongoId: apiDocId(doc),
  };
...
export function mapApiSalesDocRow(doc: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    expectedDeliveryDate: doc.expectedDeliveryDate ?? m.expectedDeliveryDate ?? '',
    deliveryMethod: doc.deliveryMethod ?? m.deliveryMethod ?? '',
    vehicleNo: doc.vehicleNo ?? m.vehicleNo ?? '',
...
export function mapApiComplaintRow(doc: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    evidenceImagePublicId: doc.evidenceImagePublicId ?? '',
...
export function mapComplaintToApi(record: Record<string, unknown>, existingLegacyId?: string): Record<string, unknown> {
  const body: Record<string, unknown> = {
    ...
    evidenceImagePublicId: record.evidenceImagePublicId ?? '',
