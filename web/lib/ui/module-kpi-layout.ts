...
const ROUTE_LAYOUTS: Record<string, ModuleKpiLayout> = {
  ...
  '/sales/quotations': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/sales/payments': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/sales/returns': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/sales/dispatch': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/sales/pos': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/purchases/goods-received': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/purchases/bills': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/purchases/payments': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/purchases/returns': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/hrm/departments': { count: 3, gridClassName: GRID_3, tableColumns: 5 },
  '/hrm/designations': { count: 3, gridClassName: GRID_3, tableColumns: 5 },
  '/hrm/attendance': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/hrm/leave': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/payroll/structures': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/payroll/runs': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/payroll/slips': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/payroll/salary-sheet': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/projects': { count: 4, gridClassName: GRID_4, tableColumns: 8 },
  '/projects/my-tasks': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/projects/team-tasks': { count: 5, gridClassName: GRID_5, tableColumns: 8 },
  '/accounting/receivables': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/accounting/payables': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/accounting/cashbox': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
  '/crm/activities': { count: 4, gridClassName: GRID_4, tableColumns: 6 },
};
