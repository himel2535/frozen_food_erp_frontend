...
export { SupplierReportsPage as ReportsSuppliersPage } from '@/components/modules/reports/suppliers/SupplierReportsPage';
export { FinancialReportsPage as ReportsFinancialPage } from '@/components/modules/reports/financial/FinancialReportsPage';
export { HrReportsPage as ReportsHrPage } from '@/components/modules/reports/hr/HrReportsPage';
