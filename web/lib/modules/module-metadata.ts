...
export const MODULE_REGISTRY: Record<string, ModuleConfig> = {
  ...
  'manufacturing-bom': { id: 'manufacturing-bom', title: 'Raw Materials BOM', subtitle: 'Bill of materials for manufacturing.', columns: [{ key: 'id', label: 'BOM #' }, { key: 'product', label: 'Product' }], staticRows: [] },
