...
export function JournalsPage() { return <DedicatedModule configId="accounting-journals" />; }
export function LedgerPage() { return <DedicatedModule configId="accounting-ledger" />; }
